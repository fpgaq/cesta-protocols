...
const main = async () => {
    ...
    // const AvaxVaultFac = await ethers.getContractFactory("AvaxVaultFuji", deployer)
    ...
    // // const AvaxStableVaultFac = await ethers.getContractFactory("AvaxStableVaultFuji", deployer)
